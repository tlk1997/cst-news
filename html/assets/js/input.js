...
//initializing
    function($) {
        ...
        function Func_Extration(text) {
            ...
            var request_url = "http://121.36.172.141:8080/get/" + text;
            ...
            $.get(request_url, function(data){
                ...
                new_table.append('<thead><tr> <th>时间</th> <th>标题</th> <th>URL</th>  </tr></thead>');			
		// }
                ...
                for(var i in data){
                    tmpt = data[i]
                    var html_ = $("<tr></tr>");
                    html_.append("<td>" + tmpt.time+ "</td>");
                    html_.append("<td>" + tmpt.title + "</td>");
                    html_.append("<td>" + tmpt.url + "</td>");
